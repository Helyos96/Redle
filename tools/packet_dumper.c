...
// TODO: use more powerful engine that can find signatures with wildcard halfbytes like 0x?8
const uint8_t get_bytes_sig[] = { 0x2B, 0xC6, 0xE8, 0x89, 0xBD, 0xAD, 0x00, 0x48, 0x01, 0xBB, 0xA8, 0x01, 0x00, 0x00, 0x48, 0x8B };
